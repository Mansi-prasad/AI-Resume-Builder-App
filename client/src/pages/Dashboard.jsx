  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <p className="text-2xl font-medium mb-6 bg-gradient-to-r from-slate-600 to-slate-700 bg-clip text-transparent sm:hidden">
          Welcome, Mansi
        </p>
        ...
        <div className="flex gap-4">
          ...
          >
            <PlusIcon className="size-11 transitaion-all duration-300 p-2.5 bg-gradient-to-br from-indigo-500 to-indigo-700 text-white rounded-full" />
          ...
          <button
            ...
            className="w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300 group hover:border-yellow-500 hover:shadow-lg transition-all duration-300 cursor-pointer"
          >
            <UploadCloudIcon className="size-11 transitaion-all duration-300 p-2.5 bg-gradient-to-br from-purple-500 to-purple-700 text-white rounded-full" />
          ...
          {allResumes.map((resume, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  Updated on:{new Date(resume.updateAt).toLocaleString()}
                </p>
                <div
