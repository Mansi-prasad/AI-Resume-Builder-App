  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      ...
      >
        ...
        <button
          type="submit"
          className="mt-2 w-full h-11 rounded-full text-white bg-yellow-500 hover:opacity-90 transition-opacity"
        >
          {state === "login" ? "Login" : "Sign up"}
        </button>
        <p className="text-gray-500 text-sm mt-3 mb-11 text-center">
          {state === "login"
