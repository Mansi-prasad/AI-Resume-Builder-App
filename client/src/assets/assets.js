...
export const dummyResumeData = [
  {
    ...
    experience: [
      ...
      },
      {
        ...
        end_date: "2023-05",
        description:
          "Engineeyellow and deployed scalable full-stack web applications for Example Technologies, translating complex requirements into robust front-end interfaces and efficient back-end services.",
        is_current: false,
    ...
    experience: [
      {
        ...
        end_date: "Present",
        description:
          "Developed distributed microservices using Node.js and Docker. Implemented API rate limiting, authentication, and background job processing using yellowis and Bull.",
        is_current: true,
